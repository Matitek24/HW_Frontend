      ...
      <tbody>
        <template v-for="project in projects" :key="project.id">
          <tr class="main-row" :class="{ 'expanded': expandedRows.includes(project.id) }"
            ...
            <td class="ps-4">
              <router-link :to="`/projekt/${project.id}`" class="fw-bold text-dark text-decoration-none underline-hover"
                @click.stop>
            ...
            <td>
              <div :id="`hat-thumb-${project.id}`" class="img-wrapper" style="width: 60px; height: 60px; padding: 5px">
          ...
          <OrderRowDetails v-if="expandedRows.includes(project.id)" :project="project"

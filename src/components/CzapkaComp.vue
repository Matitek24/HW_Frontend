...
<div style="position:relative; bottom:204px;">
  <svg id="Warstwa_1" data-name="Warstwa 1" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" viewBox="20 0 1100.79 215.94">
  <g>
...
:root {
  --kolor-gora: #f190d1;    /* Domyślnie jasny niebieski (z .cls-1) */
  --kolor-srodek: #2ac4c4;  /* Domyślnie ciemny niebieski (z .cls-3) */
  --kolor-dol: #2ac4c4;     /* Domyślnie szary (z .cls-5) */

<template>
    <div class="svg-wrapper position-relative" style="padding-top:130px;">
      ...
      <div v-if="showPompon" ref="pomponRef" class="pompon" style="position:absolute;  z-index:2; top:65px; transform: scale(3)">
...
import { exportSvgToImage } from '../../utils/exportSvg.js';

import { ensureFontLoaded } from '../../utils/fonts/fontLoader.js';
import { embedCurrentFont } from '../../utils/embedFont';
